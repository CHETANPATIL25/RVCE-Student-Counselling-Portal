...
class StudentWholeDetails extends Component {
  state = {
    category: "",
    email: "",
    blood_group: "",
  ...
  async componentDidMount() {
    ...
    try {
      const resp = await axios.post(
        `${APP_URL}/api/teacher/fetchstudentwholedetails/`,
        {
          email: this.props.userData.location.studentwholedetailsemail,
        },
        {
          headers: {
      ...
      console.log("whole details", resp.data);
      if (resp.data.status) {
        this.setState({
          ...resp.data.data,
        });
...
export default StudentWholeDetails;
